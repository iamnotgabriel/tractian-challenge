...
import { type DeleteCompanyRepository, type FindCompanyRepository, type ListCompanyRepository, type SaveCompanyRepository, type UpdateCompanyRepository } from '@/use-case/company/plugins'
